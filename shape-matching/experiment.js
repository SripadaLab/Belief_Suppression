...
var instructions_block_2 = {
	...
	pages: [
		'<div class = centerbox><p class = block-text>Now there will be one more instruction. When the prompt is in <b style="color: green">GREEN</b> text, your task is to press the <b>T</b> arrow key if they are the same shape and the <b>F</b> arrow key if they are different like you just did.</p><p class = block-text>But on some trials the prompt text will be in <b style="color:red">RED</b>. This indicates that you should lie about whether the shapes match. So if the text is red and the shapes match you would press the <b>F</b> key indicating that they do not match. If the text is red and the shapes do not match you would press the <b>T</b> key indicating that they do match.</p><p class = block-text>Press <b>Enter</b> to start a short practice.</p></div>'
	],
	allow_keys: true,
	show_clickable_nav: false,
	timing_post_trial: 1000,
