...
var getStim = function() {
	...
	if (trial_type[1] == 'T') {
		textprompt = '<div class = centerbox><p class="prompt ' + truthclass + '">Do they match?</div>';
	} else {
	...
	var target = '<div class = g1>'+center_prefix+path+target_i+'_white.png'+postfix+'</div>';
...
var instructions_block = {
	...
	pages: [
		'<div class = centerbox><p class = block-text>In this experiment you will see white shapes on the right and left of the screen along with a prompt asking if the shapes match. </p><p class = block-text>If the shapes match, press the <b>T</b> key. If they do not match, press the <b>F</b> key.</p><p class = block-text>Press <b>Enter</b> to start a short practice.</p></div>'
	],
	allow_keys: true,
...
var instructions_block_2 = {
	...
	pages: [
		'<div class = centerbox><p class = block-text>Now there will be one more instruction. When the prompt question text is in <b style="color: green">GREEN</b> text, your task is to give the answer you think is correct, just like you did in the prior trials. So you will press the <b>T</b> key if they are the same shape and the <b>F</b> key if they are different like you just did.</p><p class = block-text>But on some trials the prompt question text will be in <b style="color:red">RED</b>. This indicates that you should <b>lie</b> about whether the shapes match -- you should give the opposite of what you think the correct answer is. So if the text is red and the shapes match you would press the <b>F</b> key -- lying and indicating that they do not match. If the text is red and the shapes do not match you would press the <b>T</b> key -- lying and indicating that they do match.</p><p class = block-text>Press <b>Enter</b> to start a short practice.</p></div>'
	],
	allow_keys: true,
	show_clickable_nav: false,
	timing_post_trial: 1000,
